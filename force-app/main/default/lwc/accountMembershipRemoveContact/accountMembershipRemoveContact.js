...
import removeContact from '@salesforce/apex/AccountMembershipController.removeContact';

export default class AccountMembershipRemoveContact extends LightningElement {
    @api contactId;
